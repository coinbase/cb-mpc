...
void demo_default_base_pke_rsa() {
  ...
  buf_t Q;
  cb_assert(coinbase::api::pve::get_Q(ct, Q) == SUCCESS);
...
void demo_ac_default_base_pke_rsa() {
  ...
  std::vector<buf_t> Qs;
  cb_assert(coinbase::api::pve::get_Qs_ac(ct, Qs) == SUCCESS);
  ...
  buf_t share_p1;
  buf_t share_p2;
  cb_assert(coinbase::api::pve::party_decrypt_row_ac(curve, ac, ct, row_index, "p1",
                                                    mem_t(dks[0].data(), dks[0].size()), label, share_p1) == SUCCESS);
  cb_assert(coinbase::api::pve::party_decrypt_row_ac(curve, ac, ct, row_index, "p2",
  ...
  cb_assert(coinbase::api::pve::aggregate_to_restore_row_ac(curve, ac, ct, row_index, label, quorum, xs_out) == SUCCESS);
...
void demo_ac_default_base_pke_ecies() {
  ...
  cb_assert(coinbase::api::pve::party_decrypt_row_ac(curve, ac, ct, row_index, "p2",
                                                    mem_t(dks[1].data(), dks[1].size()), label, share_p2) == SUCCESS);
  cb_assert(coinbase::api::pve::party_decrypt_row_ac(curve, ac, ct, row_index, "p3",
...
void demo_ac_custom_base_pke() {
  ...
  buf_t share_p1;
  buf_t share_p3;
  cb_assert(coinbase::api::pve::party_decrypt_row_ac(toy, curve, ac, ct, row_index, "p1", mem_t(keys[0].data(), 32),
                                                    label, share_p1) == SUCCESS);
  cb_assert(coinbase::api::pve::party_decrypt_row_ac(toy, curve, ac, ct, row_index, "p3", mem_t(keys[2].data(), 32),
                                                    label, share_p3) == SUCCESS);
  ...
  std::vector<buf_t> xs_out;
  cb_assert(coinbase::api::pve::aggregate_to_restore_row_ac(toy, curve, ac, ct, row_index, label, quorum, xs_out) == SUCCESS);
...
void demo_batch_default_base_pke_rsa() {
  ...
  std::vector<buf_t> Qs;
  cb_assert(coinbase::api::pve::get_Qs_batch(ct, Qs) == SUCCESS);
  std::vector<mem_t> Qs_mem;
  Qs_mem.reserve(Qs.size());
  for (const auto& q : Qs) Qs_mem.emplace_back(q.data(), q.size());
