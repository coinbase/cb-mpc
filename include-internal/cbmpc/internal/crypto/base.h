...
class evp_cipher_ctx_t {
 public:
  ...
  evp_cipher_ctx_t(const evp_cipher_ctx_t&) = delete;
  evp_cipher_ctx_t& operator=(const evp_cipher_ctx_t&) = delete;
  evp_cipher_ctx_t(evp_cipher_ctx_t&&) = delete;
  evp_cipher_ctx_t& operator=(evp_cipher_ctx_t&&) = delete;
