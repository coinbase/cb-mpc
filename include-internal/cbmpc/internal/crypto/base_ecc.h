...
struct allow_ecc_infinity_t {
  ...
  allow_ecc_infinity_t(const allow_ecc_infinity_t&) = delete;
  allow_ecc_infinity_t& operator=(const allow_ecc_infinity_t&) = delete;
  allow_ecc_infinity_t(allow_ecc_infinity_t&&) = delete;
  allow_ecc_infinity_t& operator=(allow_ecc_infinity_t&&) = delete;
};
...
class consttime_point_add_scope_t {
 public:
  ...
  consttime_point_add_scope_t(const consttime_point_add_scope_t&) = delete;
  consttime_point_add_scope_t& operator=(const consttime_point_add_scope_t&) = delete;
  consttime_point_add_scope_t(consttime_point_add_scope_t&&) = delete;
  consttime_point_add_scope_t& operator=(consttime_point_add_scope_t&&) = delete;
};
