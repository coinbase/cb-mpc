...
class vartime_scope_t {
 public:
  ...
  vartime_scope_t(const vartime_scope_t&) = delete;
  vartime_scope_t& operator=(const vartime_scope_t&) = delete;
  vartime_scope_t(vartime_scope_t&&) = delete;
  vartime_scope_t& operator=(vartime_scope_t&&) = delete;
};
