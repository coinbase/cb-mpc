...
error_t party_decrypt_row_ac(const base_pke_i& base_pke, curve_id curve, const access_structure_t& ac, mem_t ciphertext,
  ...
  rv = pve_ct.party_decrypt_row(bridge, ac_internal, row_index, std::string(leaf_name),
...
error_t party_decrypt_row_ac(curve_id curve, const access_structure_t& ac, mem_t ciphertext, int row_index,
  ...
  return party_decrypt_row_ac(base_pke_default(), curve, ac, ciphertext, row_index, leaf_name, dk, label, out_share);
}
...
error_t party_decrypt_row_ac_rsa_oaep_hsm(curve_id curve, const access_structure_t& ac, mem_t ciphertext, int row_index,
  ...
  return party_decrypt_row_ac(base_pke, curve, ac, ciphertext, row_index, leaf_name, dk_handle, label, out_share);
}
...
error_t aggregate_to_restore_row_ac(const base_pke_i& base_pke, curve_id curve, const access_structure_t& ac,
  ...
  std::vector<coinbase::crypto::bn_t> xs_bn;
  rv = pve_ct.aggregate_to_restore_row(bridge, ac_internal, row_index, label, quorum_bn, xs_bn, /*skip_verify=*/true,
                                       pk_ptrs);
  if (rv) {
    out_xs.clear();
    return rv;
...
error_t aggregate_to_restore_row_ac(curve_id curve, const access_structure_t& ac, mem_t ciphertext, int row_index,
  ...
  return aggregate_to_restore_row_ac(base_pke_default(), curve, ac, ciphertext, row_index, label, quorum_shares,
                                     out_xs);
}
